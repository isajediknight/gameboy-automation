...
TITLE_SCREEN_TEMPLATE_PATH = (
    ...
    / "templates"
    / "ultraviolet"
    / "title_screen_signature.png"
)


class TitleScreen:
    """Represents the Pokémon Ultra Violet title screen."""
    ...
    def is_visible(self) -> bool:
        """Return True when the title-screen template is visible."""
    ...
    def wait_until_visible(
        ...
        """Wait until the title screen becomes visible."""
        wait_until(
